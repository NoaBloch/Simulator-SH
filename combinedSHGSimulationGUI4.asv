...
function createInputControls(gui)
    ...
    createLabeledInput(gui, 'Pulse Duration [s]', '30', [310 650 100 30], [420 650 100 30], 'Pulse_Duration_Input');
    createLabeledInput(gui, 'Repetition Rate [Hz]', '1000', [310 600 100 30], [420 600 100 30], 'Repetition_Rate_Input');
    createLabeledInput(gui, 'Average power [W]', '1', [310 550 100 30], [420 550 100 30], 'Average_power');
